    ...
    <>
      <div id="main-content" className="transition-opacity duration-300">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
              {howItWorks.map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center text-center space-y-4 border-2 border-white rounded-xl p-6 shadow-md hover:shadow-xl transition-shadow duration-300 bg-background/80"
                >
        ...
        <section className="w-full">
          <div className="mx-auto py-24 bg-white rounded-lg shadow-xl">
            <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
              ...
              <Link href="/dashboard" passHref>
                <Button
                  size="lg"
                  className="bg-black text-white h-11 mt-5 hover:bg-sky-500 hover:text-white transition-colors duration-300 shadow-md hover:shadow-lg"
                >
